...
public class TestBitalinoPlayer extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        File dataFile = new File("C:\\Users\\Jarallo\\Desktop\\Clases\\TESIS\\Test Files\\Bitalino\\ECG_test.txt");

        // Instanciar BitalinoPlayer
        bitalinoPlayer = new BitalinoPlayer(dataFile, 1, "Test BitalinoPlayer");
